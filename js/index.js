...
function renderCatalog(dataList) {
...
function updateTime() {
  ...
  const minutesPass = Math.floor(currentTime / 60) || '0';
  const secondsPass = Math.floor(currentTime % 60) || '0';
  ...
  playerTimePassed.textContent = `${minutesPass}:${secondsPass < 10 ? '0' + secondsPass : secondsPass}`;
